...
with webdriver.Chrome(service=service, options=chrome_options) as driver:
    driver.get("https://calendly.com/app/login?email=name%40website.com&lang=en")
    ...
    driver.get(
        "https://calendly.com/app/scheduled_events/all_users_and_teams?period=fixed&status_ids%XXXX=active&start_date="+str(StartDate)+"&end_date="+str(EndDate))
...
bulk = SalesforceBulk(security_token="GtUj9TRZpdkvYcH1nkoLo3OAS", username="email",
                      password='XXXXX')
